...
const Weather: React.FC<weatherProps> = ({ data, icon }) => {
  return (
    <>
      <div className="drop-shadow-lg  shadow-2xl border-black cursor-default container mx-auto bg-white/40  flex flex-col justify-center items-center rounded-xl w-1/4">
        ...
        <div id="info" className="flex justify-around w-full   items-center">
          <img src={icon} alt="" width={120} className="order-2 " />
        ...
        <div className="bg-indigo-100/50 mx-2 my-4 rounded-md  grid grid-cols-3 gap-4 p-1.5 text-center">
          ...
          >
            ...
            <img src={windflow} width={22} alt="weather" className="py-1" />
            <span>Wind flow</span>
          </div>
          ...
          >
            ...
            <img src={pressure} width={21} alt="weather" className="py-1" />
            <span>Pressure</span>
          </div>
          ...
          >
            ...
            <img src={humidity} width={22} alt="weather" className="py-1" />
            <span>Humidity</span>
          </div>
        </div>
      </div>
